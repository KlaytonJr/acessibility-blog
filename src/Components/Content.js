...
export default function Content () {   
    ...
    <div style={ContentStyle}>
        ...
        {/* <div className='Group1'><div className='Rectangle9'/>
            <span className='Itisalongestablishedfactthatareaderwillbedistractedbythereadablecontentofapagewhenlookingatitslayout'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout....</span>
            <span className='Lermais_1'>Ler mais</span>
            <span className='TitleExample_1'>Title Example</span>
            <span className='publicadoem14102022'>publicado em 14/10/2022</span>
        </div> */}
    </div>
    )
}